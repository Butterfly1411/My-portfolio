        ...
        <section className='container relative mt-10' aria-labelledby="services-heading">
            ...
            <div>
                <ul className='grid grid-cols-1 place-items-center   sm:grid-cols-2 lg:grid-cols-3 gap-10 mt-20'>
                    {data_li.map(data => (
                        <li className='lg:w-[350px] h-[300px] w-[320px]  p-5 pt-9 border-2 border-[#5ed5ea] hover:bg-[#5ed5ea] hover:text-black  rounded-[10px] focus-within:ring-2 focus-within:ring-[#5ed5ea]' key={data.id}>

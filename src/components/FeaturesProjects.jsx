...
const FeaturesProjects = () => {
  ...
  return (
    <section className='container' aria-labelledby="projects-heading">
      ...
      <div>
        <ul className='grid grid-cols-1 place-content-center sm:grid-cols-2 lg:grid-cols-3 lg:gap-15  gap-6 mt-20'>
          {project_li.map(project => (
            <li className='w-[320px] lg:w-[380px]' key={project.id}>
              <div className='lg:w-[380px] lg:h-[310px] w-[320px] h-[290px] p-6 border-2   border-[#5ed5ea]  rounded-xl bg-[#0ff]/20 backdrop-blur-xl shadow-lg
 overflow-hidden '>
                <img

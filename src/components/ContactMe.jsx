  ...
  return (
    <div className='container'>
      ...
      <div className='text-center'>
        ...
        <h1 className='text-2xl'>Contact <span>me</span>.</h1>
      ...
      <div className='grid grid-cols-1  lg:grid-cols-2 mt-4 lg:items-center lg:gap-8'>
        ...
        <div className='w-full min-h-screen text-white flex justify-center items-center px-4'>
          <form action="mailto:sabohattoshpolatova72@gmail.com" method="POST" className="w-full max-w-xl space-y-6">
            <div>
              <label className="block mb-2 text-lg font-semibold">Full Name</label>
              <input
                type="text"
                placeholder="Enter name"
                className="w-full border border-gray-700 rounded-xl py-4 px-5 text-gray-200 placeholder-gray-500 focus:outline-none focus:border-cyan-400 transition"
              />
            </div>
            ...
            <div>
              ...
              <textarea
                ...
                rows="5"
                className="w-full border border-gray-700 rounded-xl py-4 px-5 text-gray-200 placeholder-gray-500 focus:outline-none focus:border-cyan-400 transition resize-none"
              ></textarea>
            </div>

            {/* Button */}
            <button type='submit' className='text-left  items-center-center text-gray-800 bg-[#5ed5ea] mt-4 flex gap-[7px]  rounded-2xl w-[180px] h-[55px] p-4 '>
